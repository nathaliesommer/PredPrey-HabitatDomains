...
```{r Prepping plotting all - null, eval=FALSE, include=FALSE}
...
## All simulations
```{r plotting all - NULL, eval=FALSE, fig.height=11, fig.width=10, include=FALSE}
...
```{r prep plot with only survivors - NULL, eval=FALSE, include=FALSE}
...
```{r null vs model, eval=FALSE, fig.height=11, fig.width=10, include=FALSE}
