...
data <- read.csv("Data/NCvsC_1year_TSH_8x12_Nov19.csv", skip = 6, stringsAsFactors = FALSE, col.names=c("run Number", "Pred-Strat", "Prey-Start-Con",  "Pred-Start-Con", "Detect-Black",  "Detect-White", "Step", "ticks", "nearby", "mapAware-table", "Hour-Map",  "Black-Table", "White-Table", "DomainOverlap", "Domain-Prey"))
...
Write that csv file
```{r}
write.csv(final2, "Data/NCvsC_1year_TSH_Nov18.csv", row.names = FALSE)
...
data <- read_csv("Data/NCvsC_1year_TSH_Nov18.csv") 

#data<-final2

```

#Including all individuals (including those who die)
```{r plotting with all species }
