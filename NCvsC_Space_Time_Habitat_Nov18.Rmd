...
data <- read.csv("Data/YEAR1_MODELS_death_sth.csv", skip = 6, stringsAsFactors = FALSE, col.names=c("run Number", "Pred-Strat", "Prey-Start-Con",  "Pred-Start-Con", "Detect-Black",  "Detect-White", "Step", "ticks", "nearby", "mapAware-table", "Hour-Map",  "Black-Table", "White-Table", "DomainOverlap", "Domain-Prey"))
...
write.csv(final2, "/Users/kaggieorrick/Desktop/OneDrive - Yale University/NetLogo/Predator-Prey/NCvsC_1year_TSH_Nov18.csv")
...
data <- read_csv("Data/NCvsC_Space_Time_Habitat_1year_Nov18.csv") 
