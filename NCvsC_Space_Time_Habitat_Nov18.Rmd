---
title: "Habitat Domains and Predator-Prey Consumptive and Non-Consumptive Effects: shifts in space, time and habitat"
...
FILE_TO_READ <- "Data/raw_final_CvsNC_TSH_OneYear_model_8x12_Nov19.csv"
...
NAME_OF_CLEAN_DATA <-"Data/NCvsC_1year_TSH_Nov19.csv"
...
Figure X. Space, habitat and time shift of the three hunting strategies for each combination of small and large habitat domains for predators and prey of ONLY THE SURIVIORS.
```{r Plotting only with survivors - Null, echo=FALSE, , fig.width=10,fig.height=11}

suvivors.n.p <- ggplot(data = s.n, aes(x= Pred.Strat, y=value, fill = variable)) +
  geom_boxplot() +
  theme_bw(base_size = 16) +
  scale_fill_viridis_d(alpha = 0.5, labels = c("Space", "Habitat", "Time") ) +
  theme(axis.text.x = element_text(angle = 90)) +
