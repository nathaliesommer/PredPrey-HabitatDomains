...
fiveyr_null$propSafe <- fiveyr_null$Domain.Prey/(fiveyr_null$DomainOverlap + fiveyr_null$Domain.Prey)
...
onenullmod <- stan_glm(SpaceTimeshifts ~ 0 + Pred.Strat*Prey.Start.Con*Pred.Start.Con,
                     data = oneyr_null,
                     prior = t_prior,
                     cores = 2,
                     seed = 12345,
...
>>>>>>> ccc8a0efd4acccb28a41b42332ec1488171bbd76
>>>>>>> 0999891128c2d529f5ec2404ba2e2c68ec9a8af5
